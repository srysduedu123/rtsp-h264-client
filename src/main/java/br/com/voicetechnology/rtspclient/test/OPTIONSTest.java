...
public class OPTIONSTest implements ClientListener
{
	...
	private OPTIONSTest() throws Exception
	{
		...
		//client.options("*", new URI("rtsp://184.72.239.149/vod/mp4:BigBuckBunny_175k.mov"));
		client.options("*", new URI("rtsp://admin:gxtw2217@172.19.170.66/mpeg4/ch33/main/av_stream"));
	}
